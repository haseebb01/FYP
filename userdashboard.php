...
<div class="modal fade " id="rateListModal" tabindex="-1" role="dialog" aria-labelledby="rateListModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <h6>1kg Price: Rs256.78</h6><br>
                <h5>For Commercial Purpose:</h5>
                <ul>
                    <li>19kg Cylinder:  Rs4900</li>
                    <li>47kg Cylinder:  Rs12100</li>
                    <li>425kg Cylinder: Rs109200</li>
                </ul>
                <h5>For Residence Purpose:</h5>
                <ul>
                    <li>5kg Cylinder:  Rs1600</li>
                    <li>10kg Cylinder: Rs2600</li>
                    <li>14kg Cylinder: Rs3600</li>
            </div>
            <div class="modal-footer">
                Payment by cards and cash both are acceptable.
            </div>
        </div>
    </div>
</div>
