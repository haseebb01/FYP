...
<html lang="en">
    ...
    <body>
        <header>
            <nav class="navbar navbar-expand-lg navbar-light bg-custom fixed-top" style="box-shadow: rgba(0, 0, 0, 0.19) 0px 10px 20px, rgba(0, 0, 0, 0.23) 0px 6px 6px !important;">
                <div class="container">
        ...
        <footer style="overflow: hidden;">
            <div class="footer-content">
                ...
                <div class="footer-info">
                    ...
                    <br />
                    <br />
                    <p data-aos="fade-up">Phone: +923196977218</p>
                    <p>Email: haseeb@gmail.com</p>
                    <p>Social Platform</p>
